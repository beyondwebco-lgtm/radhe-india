    ...
    <div className="pt-32 pb-24 bg-slate-50 min-h-screen text-slate-700">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="prose max-w-none space-y-6 text-sm leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900">3. Data Protection & Confidentiality</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold text-slate-900">4. Contacting Our Data Officer</h2>
            <p>
            ...
            <div className="p-4 rounded-xl bg-white border border-slate-200 text-xs space-y-1 shadow-sm">
              <p className="text-slate-900 font-semibold">{COMPANY_INFO.name}</p>
